...
import jd.http.Request.NoHTMLContentException;
    ...
    public String followConnection(boolean ignoreResponseCode) throws IOException {
        ...
        if (request == null) {
            ...
            if (ignoreResponseCode) {
                request.getHttpConnection().setAllResponseCodesAllowed(true);
            }
            return this.loadConnection(request.getHttpConnection()).getHTMLSource();
        }
    }
        ...
        SHIELD_SQUARE {
            ...
            public BlockedTypeInterface isBlocked(Browser browser, Request request) {
                ...
                if (request == null || !request.isLoaded() || (con = request.getHttpConnection()) == null) {
                    ...
                    } catch (NoHTMLContentException ignore) {
                    }
                }
                return null;
            }
