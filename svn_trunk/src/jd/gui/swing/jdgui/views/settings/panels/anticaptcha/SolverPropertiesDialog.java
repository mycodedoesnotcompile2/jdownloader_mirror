...
public class SolverPropertiesDialog extends AbstractDialog<Object> {
    ...
    public SolverPropertiesDialog(SolverService editing, AbstractCaptchaSolverConfigPanel configPanel) {
        super(UIOManager.BUTTONS_HIDE_CANCEL | Dialog.STYLE_HIDE_ICON, _GUI.T.SolverPropertiesDialog_SolverPropertiesDialog_object_(editing.getName(), editing.getType().getLabel()), null, _GUI.T.lit_save_and_close(), null);
