...
@HostPlugin(revision = "$Revision: 48061 $", interfaceVersion = 2, names = { "nippyshare.com", "nippyspace.com", "nippyfile.com" }, urls = { "https?://(www\\.)?nippyshare\\.com/v/([a-z0-9]+)", "https?://(?:www\\.)?nippyspace\\.com/v/([a-z0-9]+)", "https?://(?:www\\.)?nippyfile\\.com/v/([a-z0-9]+)" })
