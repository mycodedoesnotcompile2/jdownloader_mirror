...
public class StreamwishCom extends XFileSharingProBasic {
    ...
    public static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "streamwish.com", "streamwish.to", "awish.pro", "embedwish.com", "wishembed.pro", "vidcloud.top", "gdplry.online", "jwplayerhls.com", "wishonly.site", "dwish.pro", "cloudwish.xyz", "playerwish.com" });
        return ret;
    }
