...
@HostPlugin(revision = "$Revision: 45507 $", interfaceVersion = 2, names = { "videowood.tv" }, urls = { "https?://(?:www\\.)?videowood\\.tv/(?:embed|video)/([A-Za-z0-9]+)" })
    ...
    public void handleFree(final DownloadLink downloadLink) throws Exception, PluginException {
        ...
        if (dllink == null) {
            ...
            if (dllink == null) {
                ...
                final Map<String, Object> entries = (Map<String, Object>) JavaScriptEngineFactory.jsonToJavaObject(result);
