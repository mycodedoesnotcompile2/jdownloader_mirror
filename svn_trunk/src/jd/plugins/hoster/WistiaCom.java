...
@HostPlugin(revision = "$Revision: 48043 $", interfaceVersion = 3, names = { "wistia.com" }, urls = { "https?://(?:www\\.)?ksmedia\\-gmbh\\.wistia\\.com/medias/[A-Za-z0-9]+|https?://fast\\.wistia\\.net/embed/iframe/[a-z0-9]+|https:?//fast\\.wistia\\.com/embed/medias/[A-Za-z0-9]+(.jsonp?)?" })
