...
@HostPlugin(revision = "$Revision: 47888 $", interfaceVersion = 2, names = { "4players.de" }, urls = { "https?://(?:www\\.)?4players\\.de/4players\\.php/download_info/Downloads/Download/(\\d+)/([^<>\"]*?)\\.html" })
