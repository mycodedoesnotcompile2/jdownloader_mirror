...
@HostPlugin(revision = "$Revision: 47675 $", interfaceVersion = 3, names = {}, urls = {})
public class FilericeCom extends XFileSharingProBasic {
    public FilericeCom(final PluginWrapper wrapper) {
        super(wrapper);
     ...
     * limit-info:<br />
     * captchatype-info: 2023-02-20: null <br />
     * other:<br />
     */
    public static List<String[]> getPluginDomains() {
        final List<String[]> ret = new ArrayList<String[]>();
        // each entry in List<String[]> will result in one PluginForHost, Plugin.getHost() will return String[0]->main domain
        ret.add(new String[] { "filerice.com" });
        return ret;
    }
