...
@HostPlugin(revision = "$Revision: 51949 $", interfaceVersion = 2, names = { "soundcloud.com" }, urls = { "https://(?:www\\.)?soundclouddecrypted\\.com/[A-Za-z\\-_0-9]+/[A-Za-z\\-_0-9]+(/[A-Za-z\\-_0-9]+)?" })
public class SoundcloudCom extends PluginForHost {
    ...
    public static String getFormattedFilename(final DownloadLink link) throws ParseException {
        ...
        String setsposition = link.getStringProperty(PROPERTY_setsposition, null);
