...
@HostPlugin(revision = "$Revision: 46230 $", interfaceVersion = 3, names = { "tvnow.de" }, urls = { "tvnowdecrypted://.+" })
public class TvnowDe extends PluginForHost {
    ...
    public static String getEpisodeNumber(final Map<String, Object> entries) {
        ...
        } else if (episodeO != null && episodeO instanceof Number) {
            episodenumber = episodeO.toString();
        } else {
            episodenumber = null;
        }
        ...
        synchronized (account) {
            try {
                ...
                if (!loggedIN) {
                    ...
                    final PostRequest loginReq = br.createJSonPostRequest("https://auth.tvnow.de/login", postdata);
