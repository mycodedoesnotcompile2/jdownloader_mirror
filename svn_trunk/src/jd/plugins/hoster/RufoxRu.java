...
@HostPlugin(revision = "$Revision: 34874 $", interfaceVersion = 2, names = { "rufox.ru" }, urls = { "https?://(?:www\\.)?files\\.rufox\\.ru/\\?(?:Act=byCategory&)?k=[a-z0-9]+|https?://video\\.rufox\\.ru/play/\\d+" })
