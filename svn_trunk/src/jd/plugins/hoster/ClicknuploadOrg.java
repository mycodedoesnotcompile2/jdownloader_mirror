...
@HostPlugin(revision = "$Revision: 48588 $", interfaceVersion = 3, names = {}, urls = {})
public class ClicknuploadOrg extends XFileSharingProBasic {
    ...
    public static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "clicknupload.click", "clicknupload.link", "clicknupload.red", "clicknupload.to", "clicknupload.cc", "clicknupload.co", "clicknupload.org", "clicknupload.com", "clicknupload.me", "clicknupload.club", "clicknupload.online", "clicknupload.download", "clicknupload.vip", "clickndownload.org", "clickndownload.space", "clicknupload.space" });
        return ret;
    }
