...
@HostPlugin(revision = "$Revision: 47694 $", interfaceVersion = 3, names = {}, urls = {})
public class WplikCom extends XFileSharingProBasic {
    public WplikCom(final PluginWrapper wrapper) {
        super(wrapper);
     ...
     * limit-info:<br />
     * captchatype-info: 2021-09-22: reCaptchaV2<br />
     * other:<br />
     */
    public static List<String[]> getPluginDomains() {
        final List<String[]> ret = new ArrayList<String[]>();
        // each entry in List<String[]> will result in one PluginForHost, Plugin.getHost() will return String[0]->main domain
        ret.add(new String[] { "wplik.com" });
        return ret;
    }
