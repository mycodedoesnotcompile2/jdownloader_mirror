...
public class ZzupCom extends PluginForHost {
    ...
    public static String[] getAnnotationUrls() {
        ...
        for (final String[] domains : getPluginDomains()) {
            ret.add("https?://(?:www\\.)?" + buildHostsPatternPart(domains) + "/viewimage/[^/]+/[^/]+/[^/]+/([a-z0-9\\-]+)\\.html");
        }
    ...
    public String getAGBLink() {
        return "https://" + getHost() + "/2257.html";
    }
    ...
    private AvailableStatus requestFileInformation(final DownloadLink link, final boolean isDownload) throws Exception {
        ...
        dllink = br.getRegex("\"(/[^/]+/showimage/[^\"]+)\"").getMatch(0);
        /* That commented out title down below is the same for all single image items! */
        // String title = br.getRegex("<center><span style=\"font-weight: bold;font-size: 30px;\"[^>]*>([^<]+)</span>").getMatch(0);
        // if (title != null) {
