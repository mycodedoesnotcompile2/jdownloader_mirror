...
public class AnonVCom extends KernelVideoSharingComV2 {
    ...
    public static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "anon-v.com", "private-shows.net" });
        return ret;
    }
    ...
    protected String removeUnwantedURLTitleStuff(String urltitle) {
        ...
        if (!StringUtils.isEmpty(urltitle)) {
            final String removeme = new Regex(urltitle, "(-[a-f0-9]{8,})").getMatch(0);
            if (removeme != null) {
                urltitle = urltitle.replace(removeme, "");
            }
            return super.removeUnwantedURLTitleStuff(urltitle);
        }
        return urltitle;
    }
}