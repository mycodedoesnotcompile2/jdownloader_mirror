...
public class SendNow extends XFileSharingProBasic {
    public SendNow(final PluginWrapper wrapper) {
        super(wrapper);
    ...
    public static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "send.now", "send.cm", "sendit.cloud", "usersfiles.com", "tusfiles.com", "tusfiles.net", "userscloud.com", "usercdn.com" });
        return ret;
    }
    ...
    public static class SendCmAccountFactory extends MigPanel implements AccountBuilderInterface {
        ...
        public SendCmAccountFactory(final InputChangedCallbackInterface callback, final SendNow plg) {
