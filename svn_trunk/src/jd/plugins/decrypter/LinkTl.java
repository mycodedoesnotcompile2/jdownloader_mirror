...
@DecrypterPlugin(revision = "$Revision: 52924 $", interfaceVersion = 2, names = {}, urls = {})
public class LinkTl extends antiDDoSForDecrypt {
    public LinkTl(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    public static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "link.tl", "lnkload.com", "lnk.parts", "lnk.news", "pubiza.com" });
        return ret;
    }

    protected List<String> getDeadDomains() {
        final ArrayList<String> deadDomains = new ArrayList<String>();
        deadDomains.add("pubiza.com"); // 2026-06-22
        deadDomains.add("lnk.parts"); // 2026-06-22
        return deadDomains;
    }
