...
@DecrypterPlugin(revision = "$Revision: 48163 $", interfaceVersion = 2, names = { "abload.de" }, urls = { "https?://(?:www\\.)?abload\\.de/(gallery\\.php\\?key=[A-Za-z0-9]+|browseGallery\\.php\\?gal=[A-Za-z0-9]+\\&img=.+|image.php\\?img=[\\w\\.]+)" })
