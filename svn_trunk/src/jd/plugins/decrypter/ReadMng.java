...
@DecrypterPlugin(revision = "$Revision: 48194 $", interfaceVersion = 3, names = { "readmng.com" }, urls = { "https?://(?:www\\.)?readmng\\.com/(?!new-manga/|category/|dist/|member/|noblesse/|uploads/|latest-releases/|hot-manga/|cdn-cgi/)[^/]+(?:/[\\d\\.a-z]+/?)?" })
