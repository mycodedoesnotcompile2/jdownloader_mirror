...
@DecrypterPlugin(revision = "$Revision: 45822 $", interfaceVersion = 2, names = { "pornxs.com" }, urls = { "https?://(www\\.)?pornxs\\.com/(video\\.php\\?id=|playlists/[^/]+/(?:[^/]\\.html)?|[a-z0-9\\-]+/\\d+\\-[a-z0-9\\-]*?\\.html|embed/\\d+)|https?://embed\\.pornxs\\.com/embed\\.php\\?id=\\d+" })
