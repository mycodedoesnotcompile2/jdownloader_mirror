...
@DecrypterPlugin(revision = "$Revision: 45779 $", interfaceVersion = 3, names = {}, urls = {})
public class LeitupCom extends PluginForDecrypt {
    public LeitupCom(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    public static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "leitup.com", "leit.link" });
        return ret;
    }
