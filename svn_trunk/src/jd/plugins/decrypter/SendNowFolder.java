...
import jd.plugins.hoster.SendNow;

@DecrypterPlugin(revision = "$Revision: 52974 $", interfaceVersion = 3, names = {}, urls = {})
@PluginDependencies(dependencies = { SendNow.class })
public class SendNowFolder extends PluginForDecrypt {
    public SendNowFolder(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    public static List<String[]> getPluginDomains() {
        return SendNow.getPluginDomains();
    }
