...
@DecrypterPlugin(revision = "$Revision: 35767 $", interfaceVersion = 3, names = { "booru.org" }, urls = { "https?://[a-z0-9]+\\.booru\\.org/index\\.php\\?page=post\\&s=list\\&tags=[A-Za-z0-9_\\-]+" })
public class BooruOrg extends PluginForDecrypt {
