...
@DecrypterPlugin(revision = "$Revision: 41315 $", interfaceVersion = 2, names = { "veoh.com" }, urls = { "https?://(?:www\\.)?veoh\\.com/(?:(?:browse/videos/category/.*?/)?watch/[A-Za-z0-9]+|videos/[A-Za-z0-9]+)" })
