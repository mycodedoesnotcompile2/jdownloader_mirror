...
@DecrypterPlugin(revision = "$Revision: 48630 $", interfaceVersion = 3, names = {}, urls = {})
public class BunkrAlbum extends PluginForDecrypt {
    ...
    public static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { MAIN_BUNKR_DOMAIN, "bunkr.su", "bunkr.ru", "bunkr.is", "bunkr.la", "bunkrr.ru", "bunkr.sk" });
        return ret;
    }
