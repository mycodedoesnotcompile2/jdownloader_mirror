...
@DecrypterPlugin(revision = "$Revision: 53400 $", interfaceVersion = 3, names = { "flickr.com" }, urls = { "https?://(?:secure\\.|www\\.)?flickr\\.com/(?:photos|groups)/.+" })
public class FlickrComCrawler extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(final CryptedLink param, ProgressController progress) throws Exception {
     ...
     private String getFormattedFilename(final DownloadLink dl) throws ParseException {
         return FlickrCom.getFormattedFilename(this, dl);
     }
     ...
     private String getFormattedPackagename(final FlickrAlbum album) throws ParseException {
         ...
         final String customStringForEmptyTags = FlickrCom.getCustomStringForEmptyTags(this);
     ...
     private void handleAPIErrors(final Browser br) throws Exception {
         ...
         if (StringUtils.equalsIgnoreCase(status, "fail")) {
             ...
             default:
                 ...
                 * user is 123456@N04"} </br> --> This may happen if we try to do API calls without user loggedin cookies!
                  */
