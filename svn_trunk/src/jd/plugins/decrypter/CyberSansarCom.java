...
@DecrypterPlugin(revision = "$Revision: 45830 $", interfaceVersion = 2, names = { "cybersansar.com" }, urls = { "https?://(www\\.)?cybersansar\\.com(\\.np)?/((ev_)?thumbnail_view\\.php\\?gal_id=\\d+|wallpaper_download\\.php\\?wid=\\d+|video_download\\.php\\?vid=\\d+)" })
