...
@DecrypterPlugin(revision = "$Revision: 48342 $", interfaceVersion = 3, names = { "imagecurl.com", "girlswithmuscle.com" }, urls = { "http://(?:www\\.)?imagecurl\\.com/viewer\\.php\\?file=[\\w-]+\\.[a-z]{2,4}", "https?://(www.)?girlswithmuscle\\.com/\\d+/?" })
