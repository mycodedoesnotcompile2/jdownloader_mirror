...
@DecrypterPlugin(revision = "$Revision: 47947 $", interfaceVersion = 2, names = { "mega.co.nz" }, urls = { "https?://(www\\.)?mega\\.(co\\.)?nz/(file|folder)/[a-zA-Z0-9]+(#|%23)[a-zA-Z0-9_,\\-%]{16,}(/(folder|file)/[a-zA-Z0-9]+)?" })
