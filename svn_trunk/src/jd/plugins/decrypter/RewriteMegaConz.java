...
@DecrypterPlugin(revision = "$Revision: 49286 $", interfaceVersion = 2, names = { "mega.co.nz" }, urls = { "https?://(www\\.)?mega\\.(co\\.)?nz/(file|folder|embed)/(?:!|%21)?[a-zA-Z0-9]+(#|%23|!|%21)[a-zA-Z0-9_,\\-%]{16,}(/(folder|file)/[a-zA-Z0-9]+)?" })
