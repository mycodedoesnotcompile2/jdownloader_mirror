...
@DecrypterPlugin(revision = "$Revision: 52810 $", interfaceVersion = 3, names = {}, urls = {})
public class TwitterComCrawler extends PluginForDecrypt {
    ...
    public Browser createNewBrowserInstance() {
        final Browser br = new PluginBrowser<TwitterComCrawler>(this) {
            protected String getWaitForPageAccessHost(jd.http.Request request) {
                final String ret = super.getWaitForPageAccessHost(request);
                if ("x.com".equals(ret) && StringUtils.startsWithCaseInsensitive(request.getURL().getPath(), "/i/api")) {
                    return "api.x.com";
                }
                return ret;
            };
    ...
    public void init() {
        super.init();
        setRequestIntervallLimits(this);
    }

    public static void setRequestIntervallLimits(Plugin plugin) {
        final TwitterConfigInterface cfg = plugin.get(TwitterConfigInterface.class);
        // also on x.com/i/api
    ...
    /**
     * Obtains information about given username. </br> The response of this will also expose the users' userID which is often needed to
     * perform further API requests.
     */
    private Map<String, Object> getUserInfoByUsername(final Browser br, final Account account, final String username) throws Exception {
        ...
        if (use_old_api_to_get_userid && account != null) {
            ...
            if (account == null) {
                 ...
                 * https://github.com/yeyuchen198/twitter-tid-generator and </br> https://antibot.blog/twitter-header-part-3/
                 */
                ...
                br.getPage("https://"
                        ...
                        + PluginJSonUtils.escape(username)
            ...
            for (final Map<String, Object> error : errors) {
                ...
                if (codeO != null) {
                    ...
                    case 63:
                        ...
                        // TimeFormatter.formatMilliSeconds(Long.parseLong(rateLimitResetTimestamp) - System.currentTimeMillis() / 1000,
                        // 0));
                        // }
                    case 109:
                        throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);
