...
@DecrypterPlugin(revision = "$Revision: 48316 $", interfaceVersion = 3, names = { "artstation.com" }, urls = { "https?://(?:www\\.)?artstation\\.com/((?:artist|artwork|marketplace/p/[^^/\\s]+)/[^/\\s]+|(?!about|jobs|contests|blogs|users)[^/\\s]+(/likes)?)" })
