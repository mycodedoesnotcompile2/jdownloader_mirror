...
@DecrypterPlugin(revision = "$Revision: 44439 $", interfaceVersion = 3, names = { "uploadmagnet.com" }, urls = { "https?://(?:www\\.)?(?:multi\\.hotshare\\.biz|uploadmagnet\\.com)/([a-zA-Z0-9]{1,2}_)?([a-zA-Z0-9]{12})" })
