...
public class CFG_GUI {
    ...
    public static final EnumKeyHandler<SIZEUNIT>                       MAX_SIZE_UNIT                                                        = SH.getKeyHandler("MaxSizeUnit", new TypeRef<EnumKeyHandler<SIZEUNIT>>() {
                                                                                                                                            });
    /**
    ...
    /**
     * Count disabled links normally in the 'selected' column of the download overview when the selection consists exclusively of disabled
     * links, even if 'include disabled links' is turned off
     **/
