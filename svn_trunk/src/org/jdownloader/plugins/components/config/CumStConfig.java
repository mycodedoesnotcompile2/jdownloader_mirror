...
@PluginHost(host = "cum.st", type = Type.CRAWLER)
public interface CumStConfig extends PluginConfigInterface {
    final String                    text_CrawlHttpLinksFromPostContent = "Crawl http links in post text/caption?";
    final String                    text_TextCrawlMode                 = "When to add post text/caption content as .txt file:";
