...
@HostPlugin(revision = "$Revision: 50958 $", interfaceVersion = 2, names = {}, urls = {})
public abstract class XFileSharingProBasic extends antiDDoSForHost implements DownloadConnectionVerifier {
        ...
        if (!StringUtils.isEmpty(dllink) && !preferOfficialVideoDownload) {
            ...
            download2: if ((StringUtils.isEmpty(dllink) && StringUtils.isEmpty(officialDownloadURL)) || (StringUtils.isEmpty(officialDownloadURL) && preferOfficialVideoDownload)) {
                ...
                for (int download2counter = download2start; download2counter <= download2max; download2counter++) {
                    ...
                    if (this.tryDownload(br, link, account, br.createFormRequest(download2), false)) {
                        return;
                    }
     ...
     */
    protected boolean tryDownload(final Browser br, final DownloadLink link, final Account account, final Request req, final boolean isFinalAttempt) throws Exception {
        if (req == null) {
    ...
    public void handlePremium(final DownloadLink link, final Account account) throws Exception {
        ...
        if (this.tryDownload(br, link, account, br.createGetRequest(contentURL), false)) {
            return;
        }
        ...
        if (StringUtils.isEmpty(dllink) || StringUtils.isEmpty(officialVideoDownloadURL)) {
            ...
            if (dlform != null) {
                ...
                if (this.tryDownload(br, link, account, br.createFormRequest(dlform), false)) {
                    return;
                }
    ...
    protected void handleDownload(final DownloadLink link, final Account account, final String officialVideoDownloadURL, final String directurl) throws Exception {
        ...
        this.tryDownload(br, link, account, br.createGetRequest(finalDownloadlink), true);
    }
