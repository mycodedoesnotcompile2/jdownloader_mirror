            ...
            if (sdfl_Encrypted) {
                ...
                if (pwlist.size() > 0) {
                    for (final String pw : pwlist) {
                        ...
                        if (decodedValue != null && decodedValue.matches("(?i)^[a-z0-9\\._\\-:]+$")) {
                            // password verified via sfdl_Host and allowed characters
                    ...
                    do {
                        ...
                        if (!StringUtils.isEmpty(pw)) {
                            ...
                            if (decodedValue != null && decodedValue.matches("(?i)^[a-z0-9\\._\\-:]+$")) {
                                ...
                                logger.info("User entered invalid password: " + pw + "\t" + decodedValue);
                            }
                        } else {
