                    ...
                    try {
                        ...
                        if (list != null && list.size() > 0) {
                            ...
                            if (pendingConnectFlag.compareAndSet(null, Boolean.TRUE)) {
                                ...
                                if (addr.getPort() == 443) {
                                    socketStream = HTTPConnectionImpl.getDefaultSSLSocketStreamFactory().create(socketStream, SocketConnection.getHostName(addr), 443, true, null, TrustUtils.getDefaultProvider(), null);
                                }
