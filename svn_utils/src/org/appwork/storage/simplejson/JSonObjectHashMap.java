 ...
 *
 */
public class JSonObjectHashMap extends HashMap<String, JSonNode> implements JSonObject {
     ...
     *
     */
    public JSonObjectHashMap() {
        super();
    }

    public JSonObjectHashMap(Map<String, JSonNode> map) {
        super(map);
    }
