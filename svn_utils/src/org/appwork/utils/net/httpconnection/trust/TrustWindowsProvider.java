 ...
 */
public class TrustWindowsProvider extends AbstractTrustProvider {
    ...
    private static final TrustWindowsProvider INSTANCE             = new TrustWindowsProvider();
    ...
    public static TrustWindowsProvider getInstance() {
        return INSTANCE;
    }

    private TrustWindowsProvider() {
    }
