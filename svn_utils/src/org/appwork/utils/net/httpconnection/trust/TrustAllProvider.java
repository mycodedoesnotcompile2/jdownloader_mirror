 ...
 */
public class TrustAllProvider implements TrustProviderInterface {
    private static final TrustAllProvider INSTANCE = new TrustAllProvider();

    public static TrustAllProvider getInstance() {
        return INSTANCE;
    }
    ...
    public TrustResult checkServerTrusted(final X509Certificate[] chain, final String authType, final Object context) {
        return new TrustResult(this, chain, null, TrustType.SERVER);
    }

    @Override
    public TrustResult checkClientTrusted(final X509Certificate[] chain, final String authType, final Object context) {
        return new TrustResult(this, chain, null, TrustType.CLIENT);
    }
