 ...
 *
 */
public class Java1_6TrustBridge implements X509TrustManager {
    /**
     *
     */
     ...
     *
     */
    public static final String             NO_TRUSTPROVIDER_AVAILABLE = "No Trustprovider available";

    /**
     * @param provider
     * @param options
     */
    public Java1_6TrustBridge(TrustProviderInterface provider, TrustCallback trustCallback) {
