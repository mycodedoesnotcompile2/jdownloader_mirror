...
public class HttpServerSecurityHeadersTest extends HttpServerTestBase {
    ...
    public void runTest() throws Exception {
        try {
            ...
            this.testNullConfigUsesDefaultSecurityHeaders();
    ...
    private void testDefaultSecurityHeaders() throws Exception {
        ...
        assertTrue(contentSecurityPolicy != null, "Content-Security-Policy header should be present");
        if (contentSecurityPolicy != null) {
            ...
            assertTrue(contentSecurityPolicy.contains("default-src"), "Content-Security-Policy should contain default-src directive, was: \"" + contentSecurityPolicy + "\"");
            ...
            assertTrue(contentSecurityPolicy.contains("default-src 'none'"), "Content-Security-Policy should contain default-src 'none', was: \"" + contentSecurityPolicy + "\"");
            ...
            assertTrue(contentSecurityPolicy.contains("frame-ancestors"), "Content-Security-Policy should contain frame-ancestors directive, was: \"" + contentSecurityPolicy + "\"");
        ...
        assertTrue(referrerPolicy != null, "Referrer-Policy header should be present");
    ...
    private void testCustomServerHeader() throws Exception {
        ...
        try {
            ...
            this.handlerInfo.getHttpServer().setResponseServerHeader(customHeader);
            final RequestContext context = this.httpClient.get(url);
            final int responseCode = context.getCode();
            assertTrue(responseCode == 200, "Request should return 200, was: " + responseCode);
            ...
            this.handlerInfo.getHttpServer().setResponseServerHeader(previous);
        }
    }
    ...
    /**
     * Test 2: Setting config to null should use default security headers (security by default)
     */
