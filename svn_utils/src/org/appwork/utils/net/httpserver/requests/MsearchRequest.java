...
/**
 * UPnP M-SEARCH request handler.
 * 
 * <p>
 * M-SEARCH is used to discover UPnP devices and services on the network.
 * </p>
 * 
 * <p>
...
public class MsearchRequest extends GetRequest {
     ...
     * @param connection
     */
    public MsearchRequest(final RawHttpConnectionInterface connection) {
        super(connection);
    }
