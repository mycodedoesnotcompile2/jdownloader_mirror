...
/**
 * WebDAV UNLOCK request handler.
 *
 * <p>
 * UNLOCK is used to remove the lock identified by the lock token from the resource.
 * </p>
 *
 * <p>
...
public class UnlockRequest extends AbstractGetRequest {
     ...
     * @param connection
     */
    public UnlockRequest(final RawHttpConnectionInterface connection) {
        super(connection);
    }
