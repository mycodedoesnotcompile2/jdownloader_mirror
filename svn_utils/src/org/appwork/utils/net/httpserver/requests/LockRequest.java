...
/**
 * WebDAV LOCK request handler.
 * 
 * <p>
 * LOCK is used to take out a shared or exclusive lock on a resource.
 * </p>
 * 
 * <p>
...
public class LockRequest extends PostRequest {
     ...
     * @param connection
     */
    public LockRequest(final RawHttpConnectionInterface connection) {
        super(connection);
    }
