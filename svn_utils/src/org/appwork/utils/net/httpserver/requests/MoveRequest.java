...
/**
 * WebDAV MOVE request handler.
 * 
 * <p>
 * MOVE is used to move a resource from one URI to another.
 * </p>
 * 
 * <p>
...
public class MoveRequest extends AbstractGetRequest {
     ...
     * @param connection
     */
    public MoveRequest(final RawHttpConnectionInterface connection) {
        super(connection);
    }

    @Override
    public RequestMethod getRequestMethod() {
        return RequestMethod.MOVE;
    }
}
