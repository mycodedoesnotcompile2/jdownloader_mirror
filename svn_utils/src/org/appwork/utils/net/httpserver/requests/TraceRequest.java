...
/**
 * HTTP TRACE request handler.
 *
 * <p>
 * TRACE is used for diagnostic purposes. The server echoes back the received request message.
 * </p>
 *
 * <p>
...
public class TraceRequest extends GetRequest {
     ...
     * @param connection
     */
    public TraceRequest(final RawHttpConnectionInterface connection) {
        super(connection);
    }
