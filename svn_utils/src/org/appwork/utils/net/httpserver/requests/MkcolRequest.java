...
/**
 * WebDAV MKCOL request handler.
 *
 * <p>
 * MKCOL is used to create a new collection (directory) resource.
 * </p>
 *
 * <p>
...
public class MkcolRequest extends AbstractGetRequest {
     ...
     * @param connection
     */
    public MkcolRequest(final RawHttpConnectionInterface connection) {
        super(connection);
    }

    @Override
    public RequestMethod getRequestMethod() {
        return RequestMethod.MKCOL;
    }
