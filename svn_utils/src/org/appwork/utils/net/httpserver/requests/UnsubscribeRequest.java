...
/**
 * UPnP UNSUBSCRIBE request handler.
 *
 * <p>
 * UNSUBSCRIBE is used to unsubscribe from event notifications.
 * </p>
 *
 * <p>
...
public class UnsubscribeRequest extends AbstractGetRequest {
     ...
     * @param connection
     */
    public UnsubscribeRequest(final RawHttpConnectionInterface connection) {
        super(connection);
    }
