...
/**
 * WebDAV PROPFIND request handler.
 * 
 * <p>
 * PROPFIND is used to retrieve properties defined on a resource.
 * </p>
 * 
 * <p>
...
public class PropfindRequest extends PostRequest {
     ...
     * @param connection
     */
    public PropfindRequest(final RawHttpConnectionInterface connection) {
        super(connection);
    }
