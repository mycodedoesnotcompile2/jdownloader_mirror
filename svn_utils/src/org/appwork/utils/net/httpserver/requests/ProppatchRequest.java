...
/**
 * WebDAV PROPPATCH request handler.
 * 
 * <p>
 * PROPPATCH is used to set and/or remove properties defined on a resource.
 * </p>
 * 
 * <p>
...
public class ProppatchRequest extends AbstractPostRequest {
     ...
     * @param connection
     */
    public ProppatchRequest(final RawHttpConnectionInterface connection) {
        super(connection);
    }

    @Override
    public RequestMethod getRequestMethod() {
        return RequestMethod.PROPPATCH;
    }
}
