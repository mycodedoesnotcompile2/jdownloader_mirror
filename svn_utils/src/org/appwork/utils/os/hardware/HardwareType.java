...
public class HardwareType {
    ...
    private final static HardwareTypeInterface HARDWARE = findHardware();
    ...
    private static HardwareTypeInterface findHardware() {
        ...
        final ODROID odroid = ODROID.getODROIDDetails();
        if (odroid != null) {
            return odroid;
        }
        final Synology synology = Synology.getSynologyDetails();
        if (synology != null) {
            return synology;
        }
        final QNAP qnap = QNAP.getQNAPDetails();
        if (qnap != null) {
            return qnap;
        }
        return null;
