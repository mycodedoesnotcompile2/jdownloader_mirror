...
/**
 * JNA interface to Windows IP Helper API (IPHlpAPI.dll). Used by {@link DesktopSupportWindowsViaJNA} for
 * GetTcpTable2 / GetTcp6Table2 to resolve peer PID from connection table.
 */
public interface DesktopSupportForWindowsIphlpapi extends IPHlpAPI {
    public static final int                               AF_INET  = 2;
    public static final DesktopSupportForWindowsIphlpapi INSTANCE = Native.load("IPHlpAPI", DesktopSupportForWindowsIphlpapi.class, W32APIOptions.DEFAULT_OPTIONS);
