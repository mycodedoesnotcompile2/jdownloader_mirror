 ...
 *
 */
public interface DesktopSupportProvider {
    public static DesktopSupport getDesktopSupport(OSFamily osFamily) {
        switch (osFamily) {
        case WINDOWS:
            try {
        ...
        case LINUX:
            return new DesktopSupportLinux();
        case MAC:
            return new DesktopSupportMac();
        default:
            return new DesktopSupportJavaDesktop();
        }
    }
}
