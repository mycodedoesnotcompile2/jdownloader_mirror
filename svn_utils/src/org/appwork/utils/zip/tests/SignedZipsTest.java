...
public class SignedZipsTest extends OnClassPathZipJarTests {
    ...
    public void runTest() throws Exception {
        ...
        zipper.addDirectory(Application.getResource(""), true, null);
        zipper.add(testFile, false, null);
        zipper.close();
        ...
        ZipIOWriter zipper2 = new ZipIOWriter(damaged = new ByteArrayOutputStream()) {
            ...
            /**
             * @see org.appwork.utils.zip.ZipIOWriter#addFile(java.io.File, boolean, java.lang.String)
             */
            @Override
        ...
        zipper2.addDirectory(Application.getResource(""), true, null);
        zipper2.add(testFile, false, null);
        zipper2.close();
    ...
    protected void testREader(ZipIOReader reader) throws NoSuchAlgorithmException, InvalidKeyException, IOException, SignatureException, ZipIOException, UnsupportedEncodingException {
