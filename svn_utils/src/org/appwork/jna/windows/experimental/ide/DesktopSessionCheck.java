 ...
 * ====================================================================================================================================================
 * ==================================================================================================================================================== */
package org.appwork.jna.windows.experimental.ide;
...
public class DesktopSessionCheck {
    public static void main(String[] args) throws Exception {
        ...
        // CreateProcessWithTokenW runs in the helper JVM, which is elevated (runAsAdmin). That is not the same as RUN_AS_USER_TASK / CreateProcessWithLogonW child tokens.
        AdminExecuter.runAsAdmin(new ElevatedTestTask() {
            @Override
            public Serializable run() throws Exception {
                launchAsStandardUser("cmd.exe", null, "c:\\");
                return 1l;
            }
        }, TypeRef.LONG);
    }
    ...
    public static interface Advapi32Extended extends Advapi32 {
        static final Advapi32Extended INSTANCE = Native.load("advapi32", Advapi32Extended.class, org.appwork.jna.windows.JNAOptions.SYSTEM_DLLS_ONLY);
