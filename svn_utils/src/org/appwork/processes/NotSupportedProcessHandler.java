...
public class NotSupportedProcessHandler implements ProcessHandler {
    ...
    /**
     * @throws NotSupportedException
     * @see org.appwork.processes.ProcessHandler#destroy(org.appwork.processes.ProcessInfo)
     */
    @Override
    public boolean destroy(ProcessInfo process) throws IOException, NotSupportedException {
        throw new NotSupportedException("No Supported");
    }

    /**
     * @throws NotSupportedException
     * @see org.appwork.processes.ProcessHandler#requestExit(org.appwork.processes.ProcessInfo)
     */
    @Override
    public boolean requestExit(ProcessInfo process) throws IOException, NotSupportedException {
        throw new NotSupportedException("No Supported");
    }

    /**
     * @throws NotSupportedException
     * @see org.appwork.processes.ProcessHandler#requestExit(org.appwork.utils.duration.TimeSpan, org.appwork.processes.ProcessInfo[])
     */
    @Override
    public boolean requestExit(TimeSpan waitForSoftClose, ProcessInfo... processes) throws IOException, InterruptedException, NotSupportedException {
        throw new NotSupportedException("No Supported");
    }
